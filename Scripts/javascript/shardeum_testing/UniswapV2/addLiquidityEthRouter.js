...
const addressUniswapV2Router02 = '0x841458a0b4D3df3a14DEc51CB96f1c0Fc03a96EA'
const abiUniswapV2Router02 = 
[
	{
		"inputs": [
			{
...
const contractDeployed = new ethers.Contract(addressUniswapV2Router02, abiUniswapV2Router02, signer);

// createAndSendTx()
getAddressWSHM()

async function getAddressWSHM() {  
  const storedData = await contractDeployed.WETH()

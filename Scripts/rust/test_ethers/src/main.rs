...
async fn main() -> Result<()> {
    ...
    // let wallet = "380eb0f3d505f087e438eca80bc4df9a7faa24f868e69fc0440261a0fc0567dc".parse()?;
    ...
    // let wallet: Wallet = "380eb0f3d505f087e438eca80bc4df9a7faa24f868e69fc0440261a0fc0567dc".parse()?;
    ...
    // let _receipt = client.send_transaction(tx, None);

    // let _tx2 = TransactionRequest::new()
    //     .chain_id(5)
    //     .to(other_address)
    //     .value(1000);
    // let _tx_hash2 = client.send_transaction(_tx2, None).await?;
    //
    // println!("_tx_hash2 {:?}: ", _tx_hash2);

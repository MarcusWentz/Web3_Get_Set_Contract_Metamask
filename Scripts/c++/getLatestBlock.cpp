...
// Note: C++ EVM library Silkworm (C++ Execution Layer Client):
// https://github.com/erigontech/silkworm
// is in pre alpha state based on:
// https://clientdiversity.org/
// This example is subject to change, since there might be major changes going to beta and stable status.
